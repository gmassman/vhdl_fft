...
\begin{document}
  ...
  \section*{Micro-Component Descriptions}
    ...
    \begin{itemize}
      ...
      \item FFT Block: Performs the FFT when given the start signal from the FT controller.
  ...
  \section*{Simulation Results}
    ...
    This is never really a problem for us, as the capture controller receives 512 samples over the course of about 6.4 ms, which leaves plenty of time in between cycles to compute the FFT and write the data out to the Arduino.
